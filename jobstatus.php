	...
	<div class="codes icons main-grid-border">
		<div class="container"> 
			<div class="grid_3 grid_4 w3_agileits_icons_page">
						<div class="icons">
							<h3 class="agileits-icons-title">Applied jobs</h3>
			<section id="new">
				<div class="bs-example widget-shadow" data-example-id="bordered-table"> 
                    ...
                    <?php
                                ...
                                $res=$con->query("select * from `employee_details`where `job_id`='$ai'");
                                $count=$res->num_rows;
                                if($count>0)
                                {
	                            $count=0;
                        ...
                        <td><?php echo $count;?></td>
                                ...
                                <td><a href="download.php?download=<?php echo $row["resume"];?>"><img src="images/file.png" width=100 height=100><?php echo$row["resume"];?></a></td>
