				...
				<div class="sign-up-row widget-shadow">
					...
					<form action="signup_action.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="pwd"class="form-control" id="password"placeholder="enter your passwod">
                                        </div>
                                        <div class="form-group">
                                            <label for="password">Confirm Password</label>
                                            <input type="password" name="conpwd"class="form-control" id="confirmpassword"placeholder="enter your passwod once again">
                                        </div>
                                        <center><input type="submit" class="btn btn-primary w-100 " value="Signup"></center>
                                    </form>
                                    <div class="sign-down">
				                        <center><h4>Already have an account? <a href="index.php"> Login here.</a></h4>
				                            <h5><a href="index.php">Go Back to Home</a></h5></center>
				                    </div>
				</div>
			</div>
		</div>
